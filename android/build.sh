...
for file in index.html app.js core.js data.js storage.js upload.js supabase-config.js style.css manifest.json icon-192.png icon-512.png; do
    cp "$ROOT/$file" "$BUILD/assets/www/"
done
cp -R "$ROOT/vendor" "$BUILD/assets/www/"
