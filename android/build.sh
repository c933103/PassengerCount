...
for file in index.html app.js core.js data.js government.js route-worker.js storage.js upload.js supabase-config.js style.css manifest.json icon-192.png icon-512.png; do
